...
namespace RayMueller.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        public virtual JObject DefaultSettings
        {
            get
            {
                if (_defaultSettings == null)
                {
                    ...
                    EnsureJsonProperty(_defaultSettings, "appName", "WOC Tracking");
                    ...
                    EnsureJsonProperty(ui, "theme.accent", "Yoshi");
        ...
        {
            RayMueller.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            ...
            if (Membership.GetUser("admin") == null)
            {
                ...
                admin = Membership.CreateUser("admin", "admin123%", "admin@RayMueller.com", "ASP.NET", "Code OnTime", true, out status);
                user = Membership.CreateUser("user", "user123%", "user@RayMueller.com", "ASP.NET", "Code OnTime", true, out status);
