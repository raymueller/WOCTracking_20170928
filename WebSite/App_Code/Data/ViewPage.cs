            ...
            else
            {
                ...
                if (IncludeMetadata("layouts"))
                {
                    ...
                    while (tryLoad)
                    {
                        ...
                        {
                            Stream stream = GetType().Assembly.GetManifestResourceStream(String.Format("RayMueller.Views.{0}.{1}.html", this.Controller, this.View));
                            if (stream != null)
