...
namespace RayMueller.Handlers
{
    ...
    public class SiteBase : RayMueller.Web.PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (_isTouchUI)
            {
                if (_pageFooterContent != null)
                	_pageFooterContent.Text = "<footer style=\"display:none\"><small>&copy; 2017 RayMueller. ^Copyright^All rights" +
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/RayMueller");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Yoshi.css")))
                    {
                        HtmlLink link = new HtmlLink();
                        link.Href = ("~/App_Themes/RayMueller/" + fileName);
