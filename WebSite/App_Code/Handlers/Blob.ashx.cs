...
namespace RayMueller.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("ConsentAttachmentHandler", "\"dbo\".\"Consents\"", "\"Consent\"", new string[] {
                        "\"ConsentID\""}, "Consents Consent", "Consents", "Consent");
        }
    }
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "23A73896B3048F43C1C4E2841852777135C98FC61B054914F552C434BBC428295655C8835B30DF0D6" +
                    "93D330B61B9375AB807F5E0C7DB531F7B221DFFCE77AC43";
            }
        }
